...
`)}function QE(r,e){let t;switch(e){case Eg:t="Linear";break;case wg:t="Reinhard";break;case Tg:t="Cineon";break;case Ag:t="ACESFilmic";break;case Rg:t="AgX";break;case Pg:t="Neutral";break;case Cg:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Qc=new G;function ew(){Ke.getLuminanceCoefficients(Qc);let r=Qc.x.toFixed(4),e=Qc.y.toFixed(4),t=Qc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let x=S+m+o,b=S+p+a,T=av(n,n.VERTEX_SHADER,x),C=av(n,n.FRAGMENT_SHADER,b);n.attachShader(g,T),n.attachShader(g,C),t.index0AttributeName!==void 0?n.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(g,0,"position"),n.linkProgram(g);function L(O){if(r.debug.checkShaderErrors){let V=n.getProgramInfoLog(g)||"",W=n.getShaderInfoLog(T)||"",$=n.getShaderInfoLog(C)||"",K=V.trim(),q=W.trim(),se=$.trim(),X=!0,fe=!0;if(n.getProgramParameter(g,n.LINK_STATUS)===!1)if(X=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,g,T,C);else{let ye=cv(n,T,"vertex"),we=cv(n,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(g,n.VALIDATE_STATUS)+`
...
`;var Wv=document.createElement("style");Wv.textContent=Vv;document.head.appendChild(Wv);var nr=null,Gv=!1;function vT(){nr&&j.set(nr,{opacity:0,y:Mt.distance,willChange:"transform, opacity"})}function Xv(){return!nr||Gv?Promise.resolve():(Gv=!0,new Promise(r=>{j.to(nr,{opacity:1,y:0,duration:Mt.enter,ease:Mt.ease,onComplete:()=>{nr==null||nr.style.removeProperty("will-change"),r()}})}))}rn.default.init({debug:!1,sync:!1,preventRunning:!0,transitions:[qr,zv],views:kv,prefetch:!0});rn.default.hooks.before(r=>{ya()});rn.default.hooks.beforeLeave(({current:r})=>{r!=null&&r.container?Za(r.container):Za()});rn.default.hooks.leave(r=>{if(uh(r.current.namespace)){let e=r.current.container.querySelectorAll(".project-image, .project-video");j.set(e,{opacity:1})}});rn.default.hooks.afterEnter(({next:r})=>{var i,n,s,o,a;let e=(i=r==null?void 0:r.container)!=null?i:document;Nn(e);let t=(o=(s=r==null?void 0:r.namespace)!=null?s:(n=r==null?void 0:r.container)==null?void 0:n.getAttribute("data-barba-namespace"))!=null?o:null;(a=r==null?void 0:r.container)!=null&&a.querySelector(".case-slider")&&t!=="cases"&&(Mr(r.container),Er(Mt.enter,.1)),Ka(e).then(l=>{l.length&&l.forEach(c=>{c.fadeIn(Mt.enter,0)})}).catch(l=>{console.error("Failed to initialize scoped Smooothy sliders:",l)}),t==="info"&&to(Mt.enter,0)});rn.default.hooks.once(async({next:r})=>{var s,o,a;let e=(s=r==null?void 0:r.container)!=null?s:document.querySelector('[data-barba="container"]'),t=(a=(o=r==null?void 0:r.namespace)!=null?o:e==null?void 0:e.getAttribute("data-barba-namespace"))!=null?a:null;e instanceof HTMLElement?Nn(e):Nn(document);let i=[Xv()],n=e instanceof HTMLElement?e:null;if(n!=null&&n.querySelector(".case-slider")&&t!=="cases"&&(Mr(n),Er(Mt.enter,.1)),Ka(n!=null?n:document).then(l=>{l.length&&l.forEach(c=>{c.fadeIn(Mt.enter,0)})}).catch(l=>{console.error("Failed to initialize scoped Smooothy sliders:",l)}),n){Oo(t,n);let l=Fo(t,n);i.push(l)}if(t==="info"&&to(Mt.enter,0),t==="cases"&&vs(n!=null?n:document),await Promise.all(i),t&&uh(t)&&n){Bo(n,{initialListState:"visible"});let l=n;l.__projectsFiltersInitialized=!0,gs(n,{animateMedia:!1})}});rn.default.hooks.enter(r=>{let e=document.querySelector(".preload-container");e&&(e.style.display="none")});rn.default.hooks.after(async({next:r})=>{"scrollRestoration"in history&&(history.scrollRestoration="manual");try{r!=null&&r.container&&(_h(),nl(r.container),await new Promise(e=>setTimeout(e,100)),fs(r.container),setTimeout(()=>{eo()},1e3))}catch{}setTimeout(()=>{eo()},1e3),nl(document)});rn.default.hooks.afterLeave(r=>{var e;Qp(),(e=r.current)!=null&&e.container?Co(r.current.container):Co(document),typeof window!="undefined"&&window.scrollTo(0,0)});function uh(r){return r?["projects","digital","graphic","direction","imaging"].includes(r):!1}document.addEventListener("DOMContentLoaded",()=>{nr=document.querySelector(".navbar-container"),nl(document),vT(),Xv(),typeof window!="undefined"&&window.scrollTo(0,0),Eu(),ai(),qi(document),ps(),Nn(document),vm(!1),Uv(),Nv();let r=document.querySelector('[data-barba="container"]'),e=()=>{var c;if(!(r instanceof HTMLElement))return;let n=(c=r.getAttribute("data-barba-namespace"))!=null?c:null,s=r,o=n?uh(n):!1,a=[];if(Oi(r),!o||!s.__projectsEntranceHandled){Oo(n,r);let h=Fo(n,r);a.push(h)}Promise.all(a.length?a:[Promise.resolve()]).then(()=>{o&&!s.__projectsFiltersInitialized&&(Bo(r,{initialListState:"visible"}),s.__projectsFiltersInitialized=!0),o&&!s.__projectsEntranceHandled&&gs(r,{animateMedia:!1}),n==="info"&&to(Mt.enter,0),n==="cases"&&vs(r)}),r.querySelector(".case-slider")&&(Mr(r),Er(Mt.enter,.1))},t=r instanceof HTMLElement?r.getAttribute("data-barba-namespace"):null,i=window.Webflow;if(e(),t&&uh(t)&&i&&typeof i.push=="function"&&i.push(e),!(r instanceof HTMLElement)){let n=document;n.querySelector(".case-slider")&&(Mr(n),Er(Mt.enter,.1)),t==="cases"&&vs(n)}});window.addEventListener("resize",()=>{ai(),al()&&qi(document),window.currentPanoramaSlider&&window.currentPanoramaSlider.update()});window.addEventListener("unload",()=>{nm.cleanup(),window.currentPanoramaSlider&&(window.currentPanoramaSlider.destroy(),window.currentPanoramaSlider=void 0),Ro(!0),Co(document),wr()});})();

...
`)}function ww(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ba).join(`
...
`;var u0=document.createElement("style");u0.textContent=c0;document.head.appendChild(u0);var or=null,h0=!1;function wa(r,e=1e3){Yi(r),window.setTimeout(()=>{r instanceof HTMLElement&&!document.body.contains(r)||Yi(r)},e)}function WT(){or&&j.set(or,{opacity:0,y:Mt.distance,willChange:"transform, opacity"})}function d0(){return!or||h0?Promise.resolve():(h0=!0,new Promise(r=>{j.to(or,{opacity:1,y:0,duration:Mt.enter,ease:Mt.ease,onComplete:()=>{or==null||or.style.removeProperty("will-change"),r()}})}))}an.default.init({debug:!1,sync:!1,preventRunning:!0,transitions:[Zr,l0],views:o0,prefetch:!0});an.default.hooks.before(r=>{Ho()});an.default.hooks.beforeLeave(({current:r})=>{let e=r==null?void 0:r.container;e instanceof HTMLElement||e instanceof Document?tl(e):tl()});an.default.hooks.leave(r=>{var t,i,n;let e=(i=(t=r.current)==null?void 0:t.namespace)!=null?i:null;if(_h(e)){let s=(n=r.current)==null?void 0:n.container;if(s){let o=s.querySelectorAll(".project-image, .project-video");j.set(o,{opacity:1})}}});an.default.hooks.afterEnter(({next:r})=>{var i,n,s;let e=r!=null&&r.container&&r.container instanceof HTMLElement?r.container:document;Yi(e);let t=(s=(n=r==null?void 0:r.namespace)!=null?n:(i=r==null?void 0:r.container)==null?void 0:i.getAttribute("data-barba-namespace"))!=null?s:null;t==="cases"&&(r==null?void 0:r.container)instanceof HTMLElement&&wa(r.container),(r==null?void 0:r.container)instanceof HTMLElement&&r.container.querySelector(".case-slider")&&t!=="cases"&&(Tr(r.container),Ar(Mt.enter,.1)),nl(e).then(o=>{o.length&&o.forEach(a=>{a.fadeIn(Mt.enter,0)})}).catch(o=>{}),t==="info"&&ro(Mt.enter,0)});an.default.hooks.once(async({next:r})=>{var s,o,a;let e=(s=r==null?void 0:r.container)!=null?s:document.querySelector('[data-barba="container"]'),t=(a=(o=r==null?void 0:r.namespace)!=null?o:e==null?void 0:e.getAttribute("data-barba-namespace"))!=null?a:null;e instanceof HTMLElement?Yi(e):Yi(document),t==="cases"&&e instanceof HTMLElement&&wa(e);let i=[d0()],n=e instanceof HTMLElement?e:null;if(n!=null&&n.querySelector(".case-slider")&&t!=="cases"&&(Tr(n),Ar(Mt.enter,.1)),nl(n!=null?n:document).then(l=>{l.length&&l.forEach(c=>{c.fadeIn(Mt.enter,0)})}).catch(l=>{}),n){Uo(t,n);let l=Bo(t,n);i.push(l)}if(t==="info"&&ro(Mt.enter,0),t==="cases"&&(n&&wa(n),bs(n!=null?n:document)),await Promise.all(i),t&&_h(t)&&n){let{initProjectFilters:l}=await Yr();l(n,{initialListState:"visible"});let c=n;c.__projectsFiltersInitialized=!0,ys(n,{animateMedia:!1})}});an.default.hooks.enter(r=>{let e=document.querySelector(".preload-container");e&&(e.style.display="none")});an.default.hooks.after(async({next:r})=>{"scrollRestoration"in history&&(history.scrollRestoration="manual");try{r!=null&&r.container&&(Eh(),cl(r.container),await new Promise(e=>setTimeout(e,100)),gs(r.container),setTimeout(()=>{xs()},1e3))}catch{}setTimeout(()=>{xs()},1e3),cl(document)});an.default.hooks.afterLeave(r=>{var e;fm(),(e=r.current)!=null&&e.container?Lo(r.current.container):Lo(document),typeof window!="undefined"&&window.scrollTo(0,0)});function _h(r){return r?["projects","digital","graphic","direction","imaging"].includes(r):!1}document.addEventListener("DOMContentLoaded",()=>{or=document.querySelector(".navbar-container"),cl(document),WT(),d0(),typeof window!="undefined"&&window.scrollTo(0,0),Iu(),ci(),Zi(document),vs(),Yi(document),Lm(!1),zm(),Hm();let r=document.querySelector('[data-barba="container"]'),e=()=>{var c;if(!(r instanceof HTMLElement))return;let n=(c=r.getAttribute("data-barba-namespace"))!=null?c:null,s=r,o=n?_h(n):!1,a=[];if(Ni(r),!o||!s.__projectsEntranceHandled){Uo(n,r);let h=Bo(n,r);a.push(h)}Promise.all(a.length?a:[Promise.resolve()]).then(async()=>{if(o&&!s.__projectsFiltersInitialized){let{initProjectFilters:h}=await Yr();h(r,{initialListState:"visible"}),s.__projectsFiltersInitialized=!0}o&&!s.__projectsEntranceHandled&&ys(r,{animateMedia:!1}),n==="info"&&ro(Mt.enter,0),n==="cases"&&bs(r)}),r.querySelector(".case-slider")&&(Tr(r),Ar(Mt.enter,.1)),n==="cases"&&r&&wa(r)},t=r instanceof HTMLElement?r.getAttribute("data-barba-namespace"):null,i=window.Webflow;if(e(),t&&_h(t)&&i&&typeof i.push=="function"&&i.push(e),!(r instanceof HTMLElement)){let n=document;n.querySelector(".case-slider")&&(Tr(n),Ar(Mt.enter,.1)),t==="cases"&&(wa(n),bs(n))}});window.addEventListener("resize",()=>{ci(),fl()&&Zi(document),window.currentPanoramaSlider&&window.currentPanoramaSlider.update()});window.addEventListener("unload",()=>{vm.cleanup(),window.currentPanoramaSlider&&(window.currentPanoramaSlider.destroy(),window.currentPanoramaSlider=void 0),Io(!0),Lo(document),Cr()});
